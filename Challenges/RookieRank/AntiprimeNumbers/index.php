...
fscanf(STDIN, "%d", $t);
$antiPrimes = array(1, 2, 4, 6, 12, 24, 36, 48, 60, 120, 180, 240, 360, 720, 840,
    ...
    21621600, 32432400, 36756720, 43243200, 61261200, 73513440,
    110270160, 122522400, 147026880, 183783600, 245044800, 294053760, 367567200,
    551350800, 698377680, 735134400, 1102701600, 1396755360, 2095133040, 2205403200);
while ($t--) {
    $answer = array();
    fscanf(STDIN, "%d", $n);
    $len = count($antiPrimes);
    for ($i = 0; $i < $len; $i++) {
        if ($antiPrimes[$i] >= $n) {
            echo $antiPrimes[$i] . PHP_EOL;
            break;
        }
    }
}
